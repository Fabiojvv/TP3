...
export class Mundo{
    ...
    iluminar(){
        ...
        //var luzd = new THREE.DirectionalLight( 0xffffff, 0.1 );
        //luzd.position.set( 1, 0.75, 0.5 );
        //this.escena.add( luzd );
        //var lud2 = new THREE.DirectionalLight( 0xffffff, 0.1 );
    ...
    setGuion(guion){
        ...
        this.escena.environment = pmremGenerator.fromScene( new RoomEnvironment(), 0.04, 12, 100 ).texture;
